...
namespace _03_MakingDecision
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //}
            //else { Console.WriteLine("hatalı bilgi"); }
            ...
            ////Console.WriteLine(result); burada hata veriyor çünkü result'ın ilk değeri yok ve iflerin dışında bir şart gelebilir
            ...
            //Console.WriteLine("**** C# Eğitim Kamp Restoran ****");
            //Console.WriteLine();
            //Console.WriteLine("---------------------------------");
